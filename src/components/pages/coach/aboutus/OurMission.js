const OurMission = () => {
  const missionVisionData = [
    {
      id: "mission",
      icon: "https://creativethoughtsinfo.com/CT01/nuvio/assets/img/vector-12.svg",
      title: "Our Mission",
      paragraphs: [
    ...
    {
      id: "vision",
      icon: "https://creativethoughtsinfo.com/CT01/nuvio/assets/img/vector-13.svg",
      title: "Our Vision",
      paragraphs: [
        ...
        <div className="row align-items-center gy-5">
          ...
          <div className="col-12 col-lg-6 d-flex justify-content-center justify-content-lg-end">
            <img
              ...
              src="https://creativethoughtsinfo.com/CT01/nuvio/assets/img/rectangle-4208.svg"
              width={540}
              height={554}
              priority
            />
