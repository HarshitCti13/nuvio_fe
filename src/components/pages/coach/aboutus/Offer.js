...
const Offer = () => {
  const services = [
    ...
    {
      id: 3,
      icon: "/assets/img/Coaching _Hub_icon.png",
      iconAlt: "Frame",
      iconPosition: null,
      title: "Coaching Hub",
      description:
      ...
      <div className="container-fluid">
        ...
        <div className="row align-items-center gy-4">
          ...
          <div className="col-12 col-lg-5 text-center text-lg-start mb-4 mb-lg-0">
            <img
              src="/assets/img/rectangle-4208-1.svg"
