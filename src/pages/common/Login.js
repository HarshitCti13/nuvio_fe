...
import { authSignin } from "../../redux/features/coach/actions/authAction";
...
const Login = () => {
  ...
  const handleLogin = (values) => {
    const callback = (response) => {
      if (response.success) {
        console.log({ response: response?.data?.userData?.active_subscription })
        if (response?.data?.userData?.active_subscription) {
          navigate(coachPaths?.CoachDashboard);
        } else {
          navigate(coachPaths?.CoachSubscription);
        };
      };
    };
      ...
      <div class="col-xxl-7 col-xl-6 col-lg-7 mb-4 mb-lg-0 mx-auto pe-0">
        <div class="ct_signup_right_content px-3 ct_custom_scroll pe-5">
          ...
          <div class="mt-0 text-center">
            <h2 class="ct_fs_32  mb-0 ct_darkblue_text">Welcome Back!</h2>
          </div>
          <Formik
            ...
            {({
              ...
              <form onSubmit={handleSubmit} class="mt-5">
                <div class="row">
                  ...
                  <div class="text-end">
                    <a
                      onClick={(e) => goTo(e, coachPaths.ForgotPassword)}
          ...
          <div class=" text-center mt-3 ct_darkblue_text">
            ...
            <a
              onClick={(e) => goTo(e, coachPaths.Signup)}
